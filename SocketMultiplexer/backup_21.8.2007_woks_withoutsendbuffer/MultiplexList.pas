...
procedure TSocketMultiplexListComponent.SetOnException(
  P: TExceptionEvent);
begin
  SocketList.OnException := P;
end;

function TSocketMultiplexListComponent.GetOnException: TExceptionEvent;
begin
  Result := SocketList.OnException;
end;
