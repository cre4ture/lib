========================================================================
    KONSOLENANWENDUNG: c++_interpreter-Projektübersicht
========================================================================

Diese c++_interpreter-Anwendung wurde vom Anwendungs-Assistenten 
für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre c++_interpreter-Anwendung besteht.


c++_interpreter.vcxproj
...
c++_interpreter.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "c++_interpreter.pch und eine 
